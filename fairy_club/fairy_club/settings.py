"""
Django settings for fairy_club project.
...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-(m2pd2fwobcqln#o9gc(c3-2wv(1gugl0ufpvp#gz4a&ow^3^l")
