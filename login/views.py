...
from .forms import Fairytype, UserForm, ProfileForm, MembershipTypeForm
from .models import User, globalmail, podcast as PodcastModel, uploadedpodcast
...
def mail_poll(request):
    ...
    data = [
        {'id': m.id, 'mailtitel': m.mailtitel, 'mailbody': m.mailbody}
        for m in mails
    ]
    return JsonResponse({'mails': data})
